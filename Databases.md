...
[Go Back](README.md)
# Database
## Important: When downloading the enhancement/new artifact, when importing the csv into MongoDB for the first time, make sure the date_of_birth and name fields are strings, and that ignore emptry strings is false/unchecked.
